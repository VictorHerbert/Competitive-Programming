...
#define GD_POLYGON(attr, code)                      \
  {                                                 \
    geodeb::PolyBuilder poly(attr, true, __LINE__); \
    code                                            \
  }                                                 \
  0
#define GD_POLYLINE(attr, code)                      \
  {                                                  \
    geodeb::PolyBuilder poly(attr, false, __LINE__); \
    code                                             \
  }                                                  \
  0
...
namespace geodeb
{
  ...
  public:
    template <typename T>
    Point(int line, const T &p1, const std::string &attr = kEmpty) : Point(line, p1.x, p1.y, attr) {}
    Point(int line, double x, double y, const std::string &attr = kEmpty) : OperationWithLogging("point", line, {x, y})
    {
  ...
  public:
    template <typename T>
    Segment(int line, const T &p1, const T &p2, const std::string &attr = kEmpty) : Segment(line, p1.x, p1.y, p2.x, p2.y, attr) {}
    Segment(int line,
            double x1, double y1,
            double x2, double y2,
  ...
  public:
    template <typename T>
    Triangle(int line, const T &p1, const T &p2, const T &p3, const std::string &attr = kEmpty) : Triangle(line, p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, attr) {}
    Triangle(int line,
             double x1, double y1,
             double x2, double y2,
             double x3, double y3,
  ...
  public:
    template <typename T>
    Rectangle(int line, const T &p1, const T &p2, const std::string &attr = kEmpty) : Rectangle(line, p1.x, p1.y, p2.x, p2.y, attr) {}
    Rectangle(int line,
              double x1, double y1,
              double x2, double y2,
              const std::string &attr = kEmpty)
  ...
  public:
    template <typename T>
    Circle(int line, const T &p1, double r, const std::string &attr = kEmpty) : Circle(line, p1.x, p1.y, r, attr) {}
  ...
  public:
    ...
    Arc(int line, const T &p1, double r, double sAngle, double eAngle,
        const std::string &attr = kEmpty) : Arc(line, p1.x, p1.y, r, sAngle, eAngle, attr) {}
  ...
  public:
    ...
    Pie(int line, const T &p1, double r, double sAngle, double eAngle,
        const std::string &attr = kEmpty) : Pie(line, p1.x, p1.y, r, sAngle, eAngle, attr) {}
  ...
  public:
    template <typename T>
    Line(int line, const T &p1, const T &p2, const std::string &attr = kEmpty) : Line(line, p1.x, p1.y, p2.x, p2.y, attr) {}
